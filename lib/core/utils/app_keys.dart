abstract class AppKeys {
  ...
  static const String fruitsImagesBucketName = 'fruits_images';
  //* Supabase keys
  static const String supabaseUrl = 'https://cxnyjymtbjeorfgnvbcx.supabase.co';
  ...
  static const String supabaseAnonKey =
      'sb_secret_Mc31BCVhZtQozbSOLB-WKA_XrMk2Nda'; //* Secret key
}
